  ...
  return props.active ? (
    ...
    <div className="index">
      <div>
        ...
        <p>
          Here should be a proper description of who is involved in this
          scenario, items, skills, opponents, etc.
        </p>
        <button onClick={(e) => props.beginBattle()}>
          Start this scenario
        </button>
      </div>
      <div>
        <h4>ToDo</h4>
        <p>
          Updated <strong>17-05-04</strong>.
        </p>
        <ul>
          ...
          <li className="done">
            make power half for DEF too when attacking unarmed
          </li>
