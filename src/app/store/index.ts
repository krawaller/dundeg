...
let battle: BattleState = {
  heroes: {
    hero1: makeHero(
      ...
      { HP: 18, luck: 2, gold: 5 },
      {},
      { findWeakness: true, rage: true },
      ['skinningKnife', 'shrapnelBomb', 'daemonsBlood']
    ),
    hero2: makeHero(
      'bloodsportBrawler',
      { HP: 18, luck: 3, gold: 10 },
      {},
      { backStab: true, sixthSense: true, exterminator: true },
      ['spikedGauntlet']
    ),
  },
  monsters: {
...
export const store = applyMiddleware(stepper, logger)(createStore)(reducer, <
  any
>{ battle, calculation: [], active: false })
