...
test('the backstab hero skill', (t) => {
  ...
  result = execUntil(battle, <FlowPerformHeroAttack>[
    'flow',
    'performHeroAttack',
    { heroId, attack: { stat: 'STR', type: 'meelee' } },
  ])
  t.equal(
    result.monsters.monster.vars.HP,
    monsters.imperialHuntsman.stats.HP -
      (ATK - monsters.imperialHuntsman.stats.ARM),
  ...
  result = execUntil(battle, <FlowPerformHeroAttack>[
    'flow',
    'performHeroAttack',
    { heroId, attack: { stat: 'STR', type: 'ranged' } },
  ])
  t.equal(
    result.monsters.monster.vars.HP,
    monsters.imperialHuntsman.stats.HP -
  ...
  t.equal(
    result.monsters.monster.vars.HP,
    monsters.imperialHuntsman.stats.HP -
      (ATK + 1 - monsters.imperialHuntsman.stats.ARM),
    'backstab gives no extra damage when not meelee'
  )
  ...
  result = execUntil(battle, <FlowPerformHeroAttack>[
    ...
    {
      heroId,
      attack: { stat: 'STR', type: 'special', using: 'skinningKnife' },
    },
  ])
  t.equal(
    result.monsters.monster.vars.HP,
  ...
  result = execUntil(battle, <FlowPerformHeroAttack>[
    ...
    {
      heroId,
      attack: { stat: 'STR', type: 'special', using: 'luncheonTruncheon' },
    },
  ])
  t.equal(
    result.monsters.monster.vars.HP,
  ...
  t.equal(
    result.monsters.monster.vars.HP,
    monsters.imperialHuntsman.stats.HP -
      (ATK - (monsters.imperialHuntsman.stats.ARM - 1)),
  ...
  result = execUntil(battle, <FlowPerformHeroAttack>[
    'flow',
    'performHeroAttack',
    { heroId, attack: { stat: 'STR', type: 'meelee', using: 'skinningKnife' } },
  ])
  t.equal(
    result.monsters.monster.vars.HP,
    monsters.imperialHuntsman.stats.HP -
      (ATK + 1 - (monsters.imperialHuntsman.stats.ARM - 1)),
