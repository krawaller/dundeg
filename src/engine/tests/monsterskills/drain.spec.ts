...
test('the drain monster skill', (t) => {
  let battle: BattleState = {
    ...
    monsters: {
      drainer: makeMonster('ghoulTroll', { target: 'hero', drained: 2, HP: 9 }),
    }, // ATK 6
    log: [],
  }
  ...
  t.equal(
    battle.monsters.drainer.vars.drained,
    5,
    'the 3 dealt dmg was added to drained'
  )
