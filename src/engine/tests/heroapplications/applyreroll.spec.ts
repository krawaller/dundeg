...
test('apply reroll', (t) => {
  ...
  t.ok(
    battle.heroes.hero.vars.attackDice[0] !== 666,
    'first attack die was rerolled'
  )
  ...
  t.ok(
    battle.heroes.hero.vars.defenceDice[1] !== 666,
    'second defence die was rerolled'
  )
