...
test('flow hero escape', (t) => {
  ...
  t.ok(
    ...
    'Hero cannot escape because assaulting'
  )
  ...
  t.ok(
    result.heroes.hero.vars.escaped,
    'Hero escaped directly since no monsters were targetting him'
  )
  ...
  t.ok(
    result.heroes.hero.vars.escaped,
    'Hero escaped automatically because monster wasnt active'
  )
