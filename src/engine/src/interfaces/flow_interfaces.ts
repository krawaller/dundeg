...
export type ApplyReturnToBattle = [
  'apply',
  'returnToBattle',
  ReturnToBattleSpec
]
export type ApplyRoundStart = ['apply', 'roundStart', any]
export type ApplyStanceChoice = [
  'apply',
  'stanceChoice',
  ApplyStanceChoiceToHeroSpec
]
export type ApplyStateToHero = ['apply', 'stateToHero', StateToHeroSpec]
export type ApplyStateToMonster = [
  'apply',
  'stateToMonster',
  StateToMonsterSpec
]
export type ApplyWeaknessInvocationResult = [
  'apply',
  'weaknessInvocationResult',
...
export type FlowDetonateShrapnelBomb = [
  'flow',
  'detonateShrapnelBomb',
  DetonateShrapnelBombSpec
]
...
export type FlowEachEscapedHero = [
  'flow',
  'eachEscapedHero',
  EachEscapedHeroSpec
]
...
export type FlowHeroTargetChoice = [
  'flow',
  'heroTargetChoice',
  HeroTargetChoiceSpec
]
export type FlowInitiateMonsterAttack = [
  'flow',
...
export type FlowMonsterTargetChoice = [
  'flow',
  'monsterTargetChoice',
...
export type FlowPerformHeroAttack = [
  'flow',
  'performHeroAttack',
  PerformHeroAttackSpec
]
export type FlowPerformMonsterAttack = [
  'flow',
