...
export function apply_dimwit_result(battle: BattleState, {monsterId,result}:DimwitResultSpec): BattleState {
  ...
  switch(result){
    case 'hungOver':
      ...
      addLog(ret, ['The Dimwit', {monsterRef: monsterId}, 'is hung over'], 'monsterAction');
      break;
    case 'ragingMad':
      monster.states.ragingMad = true;
      addLog(ret, ['The Dimwit', {monsterRef: monsterId}, 'is raging mad!'], 'monsterAction');
      break;
    case 'sober':
      addLog(ret, ['The Dimwit', {monsterRef: monsterId}, 'is sober'], 'monsterAction');
      break;
  }
