...
test('calculate hero defence', t => {
  const battle: BattleState = {
    heroes: {
      defenderHiPow: makeHero('bloodsportBrawler',{stance: 'defence', powerDie: 4, defenceDice: [1,3]}),
      defenderLoPow: makeHero('bloodsportBrawler',{stance: 'defence', powerDie: 2, defenceDice: [1,3]}),
