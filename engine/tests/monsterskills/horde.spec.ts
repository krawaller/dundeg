...
import { BattleState, EvilAttack, FlowPerformMonsterAttack } from '../../src/interfaces';
...
test('horde monster skill', t => {
  ...
  const battle: BattleState = {
    heroes: {
      hero: makeHero('bloodsportBrawler',{HP:startingHP,defenceDice:[1,DEF]})
    },
    monsters: {
  ...
  let monsterId = 'nacht';
  let attack:EvilAttack = {type: 'regular'};
