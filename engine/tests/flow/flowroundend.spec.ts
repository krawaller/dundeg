...
test('flow round end', t => {
  ...
  t.ok(!result.heroes.hero.vars.hasUsedPowForDefence, 'hasUsedPowForDefence was removed from heroes');
  t.ok(!result.heroes.hero.vars.hasUsedPowForDefence, 'failedDefence was removed from heroes');
