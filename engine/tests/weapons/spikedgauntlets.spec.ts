...
test('spiked gauntlets', t => {
  ...
  t.ok(!battle.question.options[items.spikedGauntlet.actions.spikedGauntletAttackDefence],'defence opt not available in assault');
  ...
  battle = reply(battle, items.spikedGauntlet.actions.spikedGauntletAttackDefence);
  t.deepEqual(
    battle.heroes.hero.vars.action[2].attack,
